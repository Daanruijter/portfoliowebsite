...
class LocalArticlesDutch extends Component {
  state = {
    localArticles: [
      {
...
export default connect(mapStateToProps, null)(LocalArticlesDutch);

      ...
      <div className="tennisNL-wrapper">
        <div className="tennisNL-information">
          ...
          <div className="tennisNL-text">
            <p>
              In januari 2014 startte ik met schrijven voor de Nederlandse
              tenniswebsite www.tennis.nl, de toenmalige nationale website over
              de tennisport. Voor zo'n anderhalf jaar schreef ik artikelen over
              het professionele nationale en internationale heren- en
              damestennis.
            </p>
          </div>
        </div>
        ...
        <div className="tennisNL-other-articles">Andere artikelen</div>
